...
namespace SmartTask.User.Commands.Models
{
    ...
    {
        private static ClaimsPrincipal GetPrincipal(SmartTaskSettings appSettings, string token)
        {
        ...
        public static string ValidateToken(SmartTaskSettings appSettings, string token)
        {
